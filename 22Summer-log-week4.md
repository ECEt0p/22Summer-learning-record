...
F1      ADD R1,R1,#-1
        BRn MAIN
        TRAP    x20
        TRAP    x21     ;Input the first number
        STR R0,R2,#0
        TRAP    x20     
        TRAP    x21     ;Input blank
        TRAP    x20
        TRAP    x21     ;Input the second number
        STR R0,R2,#1
        TRAP    x20
        TRAP    x21     ;Input Enter
        ADD R2,R2,#2
